...
export const TeammateIdleConfigSchema = z.object({
  hooks: z
    .array(
...
export const TeammateIdleInputSchema = BaseHookInputSchema.extend({
  /** TeammateIdle */
  hook_event_name: z.literal("TeammateIdle").describe("TeammateIdle"),
  /** Name of the teammate agent that became idle. */
  teammate_name: z
    .string()
    .describe("Name of the teammate agent that became idle."),
