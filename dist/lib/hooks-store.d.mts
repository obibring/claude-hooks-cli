 ...
 */
export function getHooksObject(settings: Record<string, unknown>): Record<string, unknown[]>;
/**
 ...
 */
export function addHook(settings: Record<string, unknown>, eventName: string, configEntry: object): void;
/**
 ...
 */
export function removeHook(settings: Record<string, unknown>, eventName: string, index: number): boolean;
/**
