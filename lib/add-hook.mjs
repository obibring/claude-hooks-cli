 ...
 * For scripts, builds the correct invocation with $CLAUDE_PROJECT_DIR for relative paths.
 *
 * @returns {Promise<string | null | symbol>}
 */
async function getCommandInteractive() {
  ...
  return `${runner} "$CLAUDE_PROJECT_DIR/${trimmed}"`
}
