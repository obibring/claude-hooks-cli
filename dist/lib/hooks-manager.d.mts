 ...
 */
export function saveHook(scope: SettingsScope, eventName: string, configEntry: object): Promise<{
    filePath: string;
}>;
/**
 ...
 */
export function deleteHook(scope: SettingsScope, eventName: string, index: number): Promise<{
    filePath: string;
    removed: boolean;
}>;
